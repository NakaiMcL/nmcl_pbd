...
class TestCalculator(unittest.TestCase):
    ...
    def test_calculator_ten_to_the_power(self): #tests the ten to the power functionality eg 10 to the power 2 is 100 
        result = Calculator().ten_to_the_power(2)
        self.assertEqual(100, result)
        result = Calculator().ten_to_the_power(3)
        self.assertEqual(1000, result)
        result = Calculator().ten_to_the_power(4)
        self.assertEqual(10000, result)        
        result = Calculator().ten_to_the_power(5)
